<!-- ==============================================
        ...
        <footer>
            ...
            <div class="main-footer bg-dark pt-80">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-md-offset-2 mb-80">
                            ...
                            <div class="icon-box icon-box-round icon-top">
                                ...
                                <span class="icon-inline icon-circle icon-solid-color"><i class="fa fa-microphone"></i></span>
            ...
            <div class="bg-dark">
                ...
                <div class="container text-gray text-center">
                    ...
                    <p class="mb-20 mt-20">Website by - <a href="http://www.adaptiveofficeservices.com/" target="_blank" class="text-color">Adaptive Office Services</a></p>
